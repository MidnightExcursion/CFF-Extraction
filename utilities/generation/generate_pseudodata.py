...
def generate_replica_data(dataframe: DataFrame):
    ...
    try:
        ...
        dataframe[_COLUMN_NAME_CROSS_SECTION] = [sample_from_numpy_normal_distribution(*cross_section_and_error_tuple) for cross_section_and_error_tuple in tuple(zip(dataframe[_COLUMN_NAME_CROSS_SECTION], dataframe[_COLUMN_NAME_CROSS_SECTION_ERROR]))]
